...
st.title("XGB Heart :heart: Disease Prediction")
st.write(
    f"**_Model's Accuracy using XGBoost_** :  :green[**{accuracy}**]% (:green[Tinggi])"
)
st.write("")

tab1, tab2 = st.tabs(["Prediksi Tunggal", "Prediksi Ganda"])
